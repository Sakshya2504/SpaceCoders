...
// Navigation follows the real operational workflow: active care, then history.
const NAV_ITEMS = [
  ...
  { to: '/past-patients', label: 'Past Patients', Icon: Archive },
    ...
    <aside className="sidebar" aria-label="Primary navigation">
      <div className="brand">
        <div className="brand-mark" aria-hidden="true">
          <img src="/patienttriage-mark.svg" alt="" />
        </div>
        <div>
